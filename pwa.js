...
const cacheName = 'ExtraXPFixit7NickYoumans-2020-10-27 16:54:18.840726'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'ExtraXPFixit7NickYoumans'.length) === 'ExtraXPFixit7NickYoumans') {
